      ...
      <div className="fixed inset-0 backdrop-blur-sm flex items-center justify-center text-[15px]">
        <div className="bg-white p-6 rounded-lg shadow-lg w-[auto] flex flex-col gap-10">
          ...
          <form action="" className="flex gap-10">
            <input className="border p-3" type="text" placeholder="Enter ItemCode" />
            <input className="border p-3" type="text" placeholder="Enter Product" />
            <input className="border p-3" type="number" placeholder="Enter Quantity" />
            <input className="border p-3" type="number" placeholder="Enter Mrp" />
          </form>
